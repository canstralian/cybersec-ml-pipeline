...
def get_feature_names(df):
    ...
    Args:
        df (pd.DataFrame): DataFrame to extract feature names from.

    Returns:
        list: List of numeric column names.

    Raises:
        Exception: If there is an error getting feature names.
    """
    try:
...
def list_saved_models():
    ...
    Raises:
        Exception: If there is an error listing models.
    """
    try:
        models_info = []
        models_dir = 'models'
